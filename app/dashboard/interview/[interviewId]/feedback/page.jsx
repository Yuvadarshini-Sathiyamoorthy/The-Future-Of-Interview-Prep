  ...
  return (
    <div className='p-10'>
       ...
       <h2 className='text-3xl font-bold text-green-500'>Congratulations!</h2>
        <h2 className='font-bold text-2xl'>Looks like someone got their Feedback!!</h2>
        ...
        {feedbackList&&feedbackList.map((item,index)=>(
            ...
            <CollapsibleContent>
               <div className='flex flex-col gap-2'>
                ...
                <h2 className='p-2 border rounded-lg bg-green-50 text-sm text-green-900'><strong>Suggestion: </strong>{item.correctAns}</h2>
